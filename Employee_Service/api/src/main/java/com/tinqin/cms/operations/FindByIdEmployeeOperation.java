...
public interface FindByIdEmployeeOperation extends OperationProcessor<FindByIdEmployeeResponse, FindByIdEmployeeRequest> {
    @Getter
    @Setter
    @NoArgsConstructor
    @AllArgsConstructor
    @Builder
    class FindByIdEmployeeRequest implements OperationInput {
        private String id;
    }
    ...
    @Builder
    @AllArgsConstructor
    class FindByIdEmployeeResponse implements OperationOutput {
        ...
        private FindByIdEmployeePersonalInformationResponseDTO personalInformation;
    ...
    @Builder
    @AllArgsConstructor
    class FindByIdEmployeePersonalInformationResponseDTO {
    ...
    @AllArgsConstructor
    @Builder
    class FindByIdEmployeeContactInformationResponseDTO {
    ...
    @AllArgsConstructor
    @Builder
    class FindByIdEmployeeSalaryResponseDTO {
...
//    @DecimalMin(value = "0.0", inclusive = false, message = "Salary amount must be greater than 0")
    ...
    @AllArgsConstructor
    @Builder
    class FindByIdEmployeeCreationResponseDTO {
    ...
    @AllArgsConstructor
    @Builder
    class FindByIdEmployeeEmployeeDetailsResponseDTO {
        ...
        private FindByIdEmployeeAddressResponseDTO address;
    ...
    @AllArgsConstructor
    @Builder
    class FindByIdEmployeeAddressResponseDTO {
